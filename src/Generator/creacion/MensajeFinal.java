...
public class MensajeFinal extends javax.swing.JDialog {

    int layoutX, layoutY;
    
    public MensajeFinal(CreacionPrincipal ventana, boolean modal) {
        super(creador, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(430, 130));
        ...
        jLabel1.setText("Archivo creado");
        jLabel1.setFocusable(false);
        jPanel2.add(jLabel1);
        jLabel1.setBounds(90, 30, 240, 19);
        ...
        jButton1.setBounds(170, 70, 80, 30);
